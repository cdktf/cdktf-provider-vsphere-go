...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVsphereResourcePool)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetParentResourcePoolId", GoMethod: "ResetParentResourcePoolId"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVsphereResourcePoolConfig)(nil)).Elem(),
	)
}
