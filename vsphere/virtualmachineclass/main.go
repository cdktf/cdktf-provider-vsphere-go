...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*VirtualMachineClass)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetVgpuDevices", GoMethod: "ResetVgpuDevices"},
			...
			_jsii_.MemberProperty{JsiiProperty: "vgpuDevices", GoGetter: "VgpuDevices"},
			_jsii_.MemberProperty{JsiiProperty: "vgpuDevicesInput", GoGetter: "VgpuDevicesInput"},
		},
		func() interface{} {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*VirtualMachineClassConfig)(nil)).Elem(),
	)
}
