...
type VirtualMachineCdrom struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs/resources/virtual_machine#client_device VirtualMachine#client_device}
