...
type VirtualMachineCdrom struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.9.0/docs/resources/virtual_machine#client_device VirtualMachine#client_device}
