...
type VirtualMachineCloneCustomize struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs/resources/virtual_machine#dns_server_list VirtualMachine#dns_server_list}
	DnsServerList *[]*string `field:"optional" json:"dnsServerList" yaml:"dnsServerList"`
	// A list of DNS search domains to add to the DNS configuration on the virtual machine.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs/resources/virtual_machine#dns_suffix_list VirtualMachine#dns_suffix_list}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs/resources/virtual_machine#ipv4_gateway VirtualMachine#ipv4_gateway}
	...
	// This address must be local to a static IPv4 address configured in an interface sub-resource.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs/resources/virtual_machine#ipv6_gateway VirtualMachine#ipv6_gateway}
	Ipv6Gateway *string `field:"optional" json:"ipv6Gateway" yaml:"ipv6Gateway"`
	// linux_options block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs/resources/virtual_machine#linux_options VirtualMachine#linux_options}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs/resources/virtual_machine#timeout VirtualMachine#timeout}
	Timeout *float64 `field:"optional" json:"timeout" yaml:"timeout"`
	// windows_options block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs/resources/virtual_machine#windows_options VirtualMachine#windows_options}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs/resources/virtual_machine#windows_sysprep_text VirtualMachine#windows_sysprep_text}
