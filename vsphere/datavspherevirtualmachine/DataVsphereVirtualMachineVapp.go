...
type DataVsphereVirtualMachineVapp struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.4.2/docs/data-sources/virtual_machine#properties DataVsphereVirtualMachine#properties}
