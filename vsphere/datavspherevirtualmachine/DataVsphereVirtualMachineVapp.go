...
type DataVsphereVirtualMachineVapp struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs/data-sources/virtual_machine#properties DataVsphereVirtualMachine#properties}
