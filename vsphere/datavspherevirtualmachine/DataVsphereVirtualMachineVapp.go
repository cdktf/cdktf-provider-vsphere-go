...
type DataVsphereVirtualMachineVapp struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.1/docs/data-sources/virtual_machine#properties DataVsphereVirtualMachine#properties}
