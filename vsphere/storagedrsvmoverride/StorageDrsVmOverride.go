...
import (
	...
	"github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v9/storagedrsvmoverride/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.9.2/docs/resources/storage_drs_vm_override vsphere_storage_drs_vm_override}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.9.2/docs/resources/storage_drs_vm_override vsphere_storage_drs_vm_override} Resource.
...
func StorageDrsVmOverride_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateStorageDrsVmOverride_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_StorageDrsVmOverride) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_StorageDrsVmOverride) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_StorageDrsVmOverride) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_StorageDrsVmOverride) MoveFromId(id *string) {
...
func (s *jsiiProxy_StorageDrsVmOverride) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_StorageDrsVmOverride) MoveToId(id *string) {
...
func (s *jsiiProxy_StorageDrsVmOverride) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_StorageDrsVmOverride) ToHclTerraform() interface{} {
	var returns interface{}
