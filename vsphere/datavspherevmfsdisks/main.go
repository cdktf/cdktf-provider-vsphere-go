...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVsphereVmfsDisks)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "rescan", GoGetter: "Rescan"},
			_jsii_.MemberProperty{JsiiProperty: "rescanInput", GoGetter: "RescanInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetFilter", GoMethod: "ResetFilter"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetRescan", GoMethod: "ResetRescan"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVsphereVmfsDisksConfig)(nil)).Elem(),
	)
}
