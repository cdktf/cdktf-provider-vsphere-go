...
import (
	...
	"github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v3/nasdatastore/internal"
...
func (j *jsiiProxy_NasDatastore) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_NasDatastore)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
