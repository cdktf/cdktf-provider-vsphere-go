...
func (s *jsiiProxy_Supervisor) validatePutEgressCidrParameters(value interface{}) error {
	...
	case *[]*SupervisorEgressCidr:
		value := value.(*[]*SupervisorEgressCidr)
	...
	case []*SupervisorEgressCidr:
		value_ := value.([]*SupervisorEgressCidr)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*SupervisorEgressCidr; received %#v (a %T)", value, value)
		}
	}
...
func (s *jsiiProxy_Supervisor) validatePutIngressCidrParameters(value interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*SupervisorIngressCidr:
		value := value.(*[]*SupervisorIngressCidr)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*SupervisorIngressCidr:
		value_ := value.([]*SupervisorIngressCidr)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*SupervisorIngressCidr; received %#v (a %T)", value, value)
		}
	}
...
func (s *jsiiProxy_Supervisor) validatePutNamespaceParameters(value interface{}) error {
	...
	case *[]*SupervisorNamespace:
		value := value.(*[]*SupervisorNamespace)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*SupervisorNamespace:
		value_ := value.([]*SupervisorNamespace)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*SupervisorNamespace; received %#v (a %T)", value, value)
		}
	}
...
func (s *jsiiProxy_Supervisor) validatePutPodCidrParameters(value interface{}) error {
	...
	case []*SupervisorPodCidr:
		value_ := value.([]*SupervisorPodCidr)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*SupervisorPodCidr; received %#v (a %T)", value, value)
		}
	}
