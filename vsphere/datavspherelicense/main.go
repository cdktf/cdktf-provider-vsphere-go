...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVsphereLicense)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "editionKey", GoGetter: "EditionKey"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVsphereLicenseConfig)(nil)).Elem(),
	)
}
