...
import (
	...
	"github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v2/computeclustervmdependencyrule/internal"
...
func (j *jsiiProxy_ComputeClusterVmDependencyRule) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_ComputeClusterVmDependencyRule)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
