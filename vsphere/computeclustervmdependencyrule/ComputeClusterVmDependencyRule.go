...
import (
	...
	"github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v9/computeclustervmdependencyrule/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.9.2/docs/resources/compute_cluster_vm_dependency_rule vsphere_compute_cluster_vm_dependency_rule}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.9.2/docs/resources/compute_cluster_vm_dependency_rule vsphere_compute_cluster_vm_dependency_rule} Resource.
...
func ComputeClusterVmDependencyRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateComputeClusterVmDependencyRule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ComputeClusterVmDependencyRule) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ComputeClusterVmDependencyRule) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_ComputeClusterVmDependencyRule) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_ComputeClusterVmDependencyRule) MoveFromId(id *string) {
...
func (c *jsiiProxy_ComputeClusterVmDependencyRule) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_ComputeClusterVmDependencyRule) MoveToId(id *string) {
...
func (c *jsiiProxy_ComputeClusterVmDependencyRule) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_ComputeClusterVmDependencyRule) ToHclTerraform() interface{} {
	var returns interface{}
