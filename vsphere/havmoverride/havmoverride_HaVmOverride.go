...
import (
	...
	"github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v3/havmoverride/internal"
...
func (j *jsiiProxy_HaVmOverride) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_HaVmOverride)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
