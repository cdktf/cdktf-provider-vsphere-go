...
import (
	...
	"github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v9/havmoverride/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.9.0/docs/resources/ha_vm_override vsphere_ha_vm_override}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.9.0/docs/resources/ha_vm_override vsphere_ha_vm_override} Resource.
...
func (h *jsiiProxy_HaVmOverride) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (h *jsiiProxy_HaVmOverride) ToHclTerraform() interface{} {
	var returns interface{}
