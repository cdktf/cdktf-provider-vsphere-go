...
import (
	...
	"github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v3/computeclustervmantiaffinityrule/internal"
...
func (j *jsiiProxy_ComputeClusterVmAntiAffinityRule) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_ComputeClusterVmAntiAffinityRule)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
