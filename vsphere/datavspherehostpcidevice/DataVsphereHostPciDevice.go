...
import (
	...
	"github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v9/datavspherehostpcidevice/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.9.2/docs/data-sources/host_pci_device vsphere_host_pci_device}.
...
func (j *jsiiProxy_DataVsphereHostPciDevice) Count() interface{} {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.9.2/docs/data-sources/host_pci_device vsphere_host_pci_device} Data Source.
...
func (j *jsiiProxy_DataVsphereHostPciDevice)SetCount(val interface{}) {
...
func DataVsphereHostPciDevice_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataVsphereHostPciDevice_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataVsphereHostPciDevice) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataVsphereHostPciDevice) ToHclTerraform() interface{} {
	var returns interface{}
