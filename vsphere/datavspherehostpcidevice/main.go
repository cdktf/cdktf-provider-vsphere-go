...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVsphereHostPciDevice)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "cdktfStack", GoGetter: "CdktfStack"},
			_jsii_.MemberProperty{JsiiProperty: "classId", GoGetter: "ClassId"},
			_jsii_.MemberProperty{JsiiProperty: "classIdInput", GoGetter: "ClassIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetClassId", GoMethod: "ResetClassId"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetNameRegex", GoMethod: "ResetNameRegex"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetVendorId", GoMethod: "ResetVendorId"},
			...
			_jsii_.MemberProperty{JsiiProperty: "vendorIdInput", GoGetter: "VendorIdInput"},
		},
		func() interface{} {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVsphereHostPciDeviceConfig)(nil)).Elem(),
	)
}
