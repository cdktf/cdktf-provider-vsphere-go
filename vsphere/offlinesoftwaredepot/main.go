...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*OfflineSoftwareDepot)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*OfflineSoftwareDepotComponent)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-vsphere.offlineSoftwareDepot.OfflineSoftwareDepotComponentList",
		reflect.TypeOf((*OfflineSoftwareDepotComponentList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*OfflineSoftwareDepotComponentOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*OfflineSoftwareDepotConfig)(nil)).Elem(),
	)
}
