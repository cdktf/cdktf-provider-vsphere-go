...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ContentLibrary)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putPublication", GoMethod: "PutPublication"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPublication", GoMethod: "ResetPublication"},
			_jsii_.MemberMethod{JsiiMethod: "resetSubscription", GoMethod: "ResetSubscription"},
			_jsii_.MemberProperty{JsiiProperty: "storageBacking", GoGetter: "StorageBacking"},
			_jsii_.MemberProperty{JsiiProperty: "storageBackingInput", GoGetter: "StorageBackingInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ContentLibraryConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-vsphere.contentLibrary.ContentLibraryPublication",
		reflect.TypeOf((*ContentLibraryPublication)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-vsphere.contentLibrary.ContentLibraryPublicationOutputReference",
		reflect.TypeOf((*ContentLibraryPublicationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "publishUrl", GoGetter: "PublishUrl"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ContentLibrarySubscription)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-vsphere.contentLibrary.ContentLibrarySubscriptionOutputReference",
		reflect.TypeOf((*ContentLibrarySubscriptionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "authenticationMethod", GoGetter: "AuthenticationMethod"},
			_jsii_.MemberProperty{JsiiProperty: "authenticationMethodInput", GoGetter: "AuthenticationMethodInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPassword", GoMethod: "ResetPassword"},
			_jsii_.MemberMethod{JsiiMethod: "resetSubscriptionUrl", GoMethod: "ResetSubscriptionUrl"},
			_jsii_.MemberMethod{JsiiMethod: "resetUsername", GoMethod: "ResetUsername"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
