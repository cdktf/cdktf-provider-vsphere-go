...
import (
	...
	"github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v2/datavsphereovfvmtemplate/internal"
...
func (j *jsiiProxy_DataVsphereOvfVmTemplate) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DataVsphereOvfVmTemplate)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
