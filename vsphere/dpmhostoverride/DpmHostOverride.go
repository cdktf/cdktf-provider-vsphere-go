...
import (
	...
	"github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v9/dpmhostoverride/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.8.2/docs/resources/dpm_host_override vsphere_dpm_host_override}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.8.2/docs/resources/dpm_host_override vsphere_dpm_host_override} Resource.
...
func DpmHostOverride_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDpmHostOverride_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DpmHostOverride) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DpmHostOverride) HasResourceMove() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DpmHostOverride) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DpmHostOverride) MoveFromId(id *string) {
...
func (d *jsiiProxy_DpmHostOverride) MoveTo(moveTarget *string, index interface{}) {
...
func (d *jsiiProxy_DpmHostOverride) MoveToId(id *string) {
...
func (d *jsiiProxy_DpmHostOverride) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DpmHostOverride) ToHclTerraform() interface{} {
	var returns interface{}
