...
import (
	...
	"github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v8/tag/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.5.1/docs/resources/tag vsphere_tag}.
type Tag interface {
...
func (j *jsiiProxy_Tag) CategoryId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"categoryId",
...
func (j *jsiiProxy_Tag) CategoryIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"categoryIdInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.5.1/docs/resources/tag vsphere_tag} Resource.
...
func (j *jsiiProxy_Tag)SetCategoryId(val *string) {
