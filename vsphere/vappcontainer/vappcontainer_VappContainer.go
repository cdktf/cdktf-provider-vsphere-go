...
import (
	...
	"github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v3/vappcontainer/internal"
...
func (j *jsiiProxy_VappContainer) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_VappContainer)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
