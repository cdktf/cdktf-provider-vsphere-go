...
import (
	...
	"github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v11/vappcontainer/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs/resources/vapp_container vsphere_vapp_container}.
...
// Create a new {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs/resources/vapp_container vsphere_vapp_container} Resource.
...
func VappContainer_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateVappContainer_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (v *jsiiProxy_VappContainer) AddMoveTarget(moveTarget *string) {
...
func (v *jsiiProxy_VappContainer) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (v *jsiiProxy_VappContainer) ToHclTerraform() interface{} {
	var returns interface{}
