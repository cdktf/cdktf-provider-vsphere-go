...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*VappContainer)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "parentFolderIdInput", GoGetter: "ParentFolderIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetParentFolderId", GoMethod: "ResetParentFolderId"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*VappContainerConfig)(nil)).Elem(),
	)
}
