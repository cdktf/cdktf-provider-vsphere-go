...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*VirtualDisk)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "vmdkPath", GoGetter: "VmdkPath"},
			_jsii_.MemberProperty{JsiiProperty: "vmdkPathInput", GoGetter: "VmdkPathInput"},
		},
		func() interface{} {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*VirtualDiskConfig)(nil)).Elem(),
	)
}
