...
type VmfsDatastoreConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.8.2/docs/resources/vmfs_datastore#host_system_id VmfsDatastore#host_system_id}
