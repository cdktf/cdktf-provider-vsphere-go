...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVsphereNetwork)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDistributedVirtualSwitchUuid", GoMethod: "ResetDistributedVirtualSwitchUuid"},
			...
			_jsii_.MemberProperty{JsiiProperty: "retryTimeoutInput", GoGetter: "RetryTimeoutInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVsphereNetworkConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-vsphere.dataVsphereNetwork.DataVsphereNetworkFilter",
		reflect.TypeOf((*DataVsphereNetworkFilter)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-vsphere.dataVsphereNetwork.DataVsphereNetworkFilterList",
		reflect.TypeOf((*DataVsphereNetworkFilterList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVsphereNetworkFilterOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
