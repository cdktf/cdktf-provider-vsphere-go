...
import (
	...
	"github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v9/role/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.7.0/docs/resources/role vsphere_role}.
type Role interface {
...
func (j *jsiiProxy_Role) Label() *string {
	var returns *string
	_jsii_.Get(
		j,
		"label",
...
func (j *jsiiProxy_Role) RolePrivileges() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"rolePrivileges",
...
func (j *jsiiProxy_Role) RolePrivilegesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"rolePrivilegesInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.7.0/docs/resources/role vsphere_role} Resource.
...
func (j *jsiiProxy_Role)SetRolePrivileges(val *[]*string) {
...
func (r *jsiiProxy_Role) ResetRolePrivileges() {
	_jsii_.InvokeVoid(
		r,
		"resetRolePrivileges",
		nil, // no parameters
