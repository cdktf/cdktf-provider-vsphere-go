...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*EntityPermissions)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*EntityPermissionsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-vsphere.entityPermissions.EntityPermissionsPermissions",
		reflect.TypeOf((*EntityPermissionsPermissions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-vsphere.entityPermissions.EntityPermissionsPermissionsList",
		reflect.TypeOf((*EntityPermissionsPermissionsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*EntityPermissionsPermissionsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "isGroup", GoGetter: "IsGroup"},
			_jsii_.MemberProperty{JsiiProperty: "isGroupInput", GoGetter: "IsGroupInput"},
			_jsii_.MemberProperty{JsiiProperty: "propagate", GoGetter: "Propagate"},
			_jsii_.MemberProperty{JsiiProperty: "propagateInput", GoGetter: "PropagateInput"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			...
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
			_jsii_.MemberProperty{JsiiProperty: "userOrGroup", GoGetter: "UserOrGroup"},
			_jsii_.MemberProperty{JsiiProperty: "userOrGroupInput", GoGetter: "UserOrGroupInput"},
		},
		func() interface{} {
