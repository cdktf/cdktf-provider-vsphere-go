...
import (
	...
	"github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v3/resourcepool/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://www.terraform.io/docs/providers/vsphere/r/resource_pool vsphere_resource_pool}.
...
func (j *jsiiProxy_ResourcePool) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://www.terraform.io/docs/providers/vsphere/r/resource_pool vsphere_resource_pool} Resource.
...
func (j *jsiiProxy_ResourcePool)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
