...
import (
	...
	"github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v11/resourcepool/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs/resources/resource_pool vsphere_resource_pool}.
...
// Create a new {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs/resources/resource_pool vsphere_resource_pool} Resource.
...
func ResourcePool_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateResourcePool_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_ResourcePool) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_ResourcePool) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (r *jsiiProxy_ResourcePool) ToHclTerraform() interface{} {
	var returns interface{}
