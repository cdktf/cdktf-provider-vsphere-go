...
import (
	...
	"github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v9/datastoreclustervmantiaffinityrule/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.9.0/docs/resources/datastore_cluster_vm_anti_affinity_rule vsphere_datastore_cluster_vm_anti_affinity_rule}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.9.0/docs/resources/datastore_cluster_vm_anti_affinity_rule vsphere_datastore_cluster_vm_anti_affinity_rule} Resource.
...
func DatastoreClusterVmAntiAffinityRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDatastoreClusterVmAntiAffinityRule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DatastoreClusterVmAntiAffinityRule) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DatastoreClusterVmAntiAffinityRule) HasResourceMove() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DatastoreClusterVmAntiAffinityRule) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DatastoreClusterVmAntiAffinityRule) MoveFromId(id *string) {
...
func (d *jsiiProxy_DatastoreClusterVmAntiAffinityRule) MoveTo(moveTarget *string, index interface{}) {
...
func (d *jsiiProxy_DatastoreClusterVmAntiAffinityRule) MoveToId(id *string) {
...
func (d *jsiiProxy_DatastoreClusterVmAntiAffinityRule) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DatastoreClusterVmAntiAffinityRule) ToHclTerraform() interface{} {
	var returns interface{}
