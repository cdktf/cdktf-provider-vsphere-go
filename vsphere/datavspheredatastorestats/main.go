...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVsphereDatastoreStats)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "freeSpaceInput", GoGetter: "FreeSpaceInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetFreeSpace", GoMethod: "ResetFreeSpace"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVsphereDatastoreStatsConfig)(nil)).Elem(),
	)
}
