# CDKTF Go bindings for vmware/vsphere provider version 2.14.2

This repo builds and publishes the [Terraform vsphere provider](https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
* [Terraform vsphere provider](https://registry.terraform.io/providers/vmware/vsphere/2.14.2)
