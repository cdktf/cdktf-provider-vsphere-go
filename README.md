# CDKTF Go bindings for hashicorp/vsphere provider version 2.8.2

This repo builds and publishes the [Terraform vsphere provider](https://registry.terraform.io/providers/hashicorp/vsphere/2.8.2/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
* [Terraform vsphere provider](https://registry.terraform.io/providers/hashicorp/vsphere/2.8.2)
